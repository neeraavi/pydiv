...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1101, 811))
        ...
        self.transactionsView.setGeometry(QtCore.QRect(10, 400, 441, 371))
        font = QtGui.QFont()
        ...
        self.dividendsView.setGeometry(QtCore.QRect(460, 400, 631, 371))
        font = QtGui.QFont()
        font.setFamily("Noto Mono")
        font.setPointSize(9)
        ...
        self.label.setGeometry(QtCore.QRect(10, 380, 101, 17))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.tab_1)
        self.label_2.setGeometry(QtCore.QRect(460, 380, 67, 17))
        self.label_2.setObjectName("label_2")
        self.mainFilter = QtWidgets.QLineEdit(self.tab_1)
        self.mainFilter.setGeometry(QtCore.QRect(962, 370, 121, 25))
        self.mainFilter.setObjectName("mainFilter")
        self.showClosedPositions = QtWidgets.QCheckBox(self.tab_1)
        self.showClosedPositions.setGeometry(QtCore.QRect(730, 370, 211, 23))
        self.showClosedPositions.setObjectName("showClosedPositions")
        self.searchAllColumns = QtWidgets.QCheckBox(self.tab_1)
        self.searchAllColumns.setGeometry(QtCore.QRect(550, 370, 171, 23))
        ...
        self.dividendCalendar.setGeometry(QtCore.QRect(0, 0, 591, 391))
        self.dividendCalendar.setObjectName("dividendCalendar")
        self.dividendCalendarView = QtWidgets.QTableView(self.dividendCalendar)
        self.dividendCalendarView.setGeometry(QtCore.QRect(10, 60, 571, 321))
        font = QtGui.QFont()
        ...
        self.investmentCalendar.setGeometry(QtCore.QRect(0, 410, 591, 361))
        ...
        self.investmentCalendarView.setGeometry(QtCore.QRect(10, 40, 571, 311))
        font = QtGui.QFont()
        font.setFamily("Fira Code")
        font.setPointSize(10)
        ...
        self.calendarDetailsView.setGeometry(QtCore.QRect(600, 20, 491, 751))
        ...
        self.listView.setGeometry(QtCore.QRect(10, 10, 451, 301))
        self.listView.setObjectName("listView")
        self.graphicsView = QtWidgets.QGraphicsView(self.tab_3)
        self.graphicsView.setGeometry(QtCore.QRect(10, 320, 1071, 221))
        self.graphicsView.setObjectName("graphicsView")
        self.graphicsView_2 = QtWidgets.QGraphicsView(self.tab_3)
        self.graphicsView_2.setGeometry(QtCore.QRect(10, 550, 1071, 221))
