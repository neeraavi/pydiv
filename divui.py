...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.transactionsView.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.transactionsView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.dividendsView.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.dividendsView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.label_2.setGeometry(QtCore.QRect(460, 410, 81, 17))
        ...
        self.showClosedPositions.setGeometry(QtCore.QRect(750, 400, 211, 23))
        self.showClosedPositions.setObjectName("showClosedPositions")
        self.searchAllColumns = QtWidgets.QCheckBox(self.tab_1)
        self.searchAllColumns.setGeometry(QtCore.QRect(560, 400, 181, 23))
        ...
        self.calendarDetailsView.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        ...
        self.calendarDetailsView.verticalHeader().setDefaultSectionSize(12)
        self.calendarDetailsView.verticalHeader().setMinimumSectionSize(10)
        ...
        self.yf_view = QtWidgets.QTableView(self.tab_4)
        self.yf_view.setGeometry(QtCore.QRect(10, 0, 1081, 771))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        self.yf_view.setFont(font)
        self.yf_view.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.yf_view.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.yf_view.setSortingEnabled(True)
        self.yf_view.setObjectName("yf_view")
        self.yf_filter = QtWidgets.QLineEdit(self.tab_4)
        self.yf_filter.setGeometry(QtCore.QRect(880, 780, 211, 30))
        self.yf_filter.setObjectName("yf_filter")
        self.yf_searchAllColumns = QtWidgets.QCheckBox(self.tab_4)
        self.yf_searchAllColumns.setGeometry(QtCore.QRect(650, 780, 211, 28))
        self.yf_searchAllColumns.setObjectName("yf_searchAllColumns")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Dividend Tracker py-v20230421"))
        ...
        self.yf_searchAllColumns.setText(_translate("MainWindow", "[F2] Search all columns"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "yf"))
