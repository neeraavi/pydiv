...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.summaryView.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.summaryView.setAlternatingRowColors(True)
        ...
        self.transactionsView.setGeometry(QtCore.QRect(10, 360, 441, 281))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(11)
        ...
        self.dividendsView.setGeometry(QtCore.QRect(460, 360, 631, 281))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(11)
